            ...
            <div className="donate-content fade-in-left">
              ...
              <div className="donate-info-grid">
                <div className="donate-info-card">
                  ...
                  <p>$50 covers materials for one student for a whole semester.</p>
                </div>
                <div className="donate-info-card">
                  <div className="icon">
                  ...
                  <p>$500 provides laptops and software for a workshop group.</p>
                </div>
              </div>
                  ...
                  <div className="amount-grid">
                    {['25', '50', '100', '250', '500'].map((amt) => (
                      <div className="amount-option" key={amt}>
                        <input type="radio" name="amount" id={`amount-${amt}`} value={amt} defaultChecked={amt === '50'} />
                        <label htmlFor={`amount-${amt}`}><span>${amt}</span></label>
                      </div>
                    ))}
